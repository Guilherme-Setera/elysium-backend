...
from src.modules.receitas.controller.router import router as receitas_router
from src.modules.itens_producao.controller.router import router as itens_producao_router
...
api_router.include_router(itens_producao_router)
